...
public class MutanteChorreante extends Enemigo implements Mutante{

	Scanner sc = new Scanner(System.in);
	
	public MutanteChorreante() {  //TODOS los constructores estos son para players. Habrá otros para npcs
